...
def main():
    ...
    #     f.write("frame_id,time,fx,fy,fz,mx,my,mz,depth_mean,deformation_mean\n")
    ...
    try:
        while dpg.is_dearpygui_running():
            ...
            #         f.write(f"{fid},{t:.3f},{fx:.3f},{fy:.3f},{fz:.3f},{mx:.3f},{my:.3f},{mz:.3f},{depth.mean():.3f},{deformation.mean():.3f}\n")
